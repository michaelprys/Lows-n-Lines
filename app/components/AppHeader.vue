<template>
  <div class="sticky top-0 z-[10] w-full">
    <ItemObserver v-slot="{ isVisible }">
      <header class="header" :class="{ active: isHidden }" ref="el">
        ...
        >
          ...
          <div class="row-start-2 flex flex-1 justify-end">
            <div class="flex gap-10 lg-max:gap-4">
              <div>
          ...
          <NuxtLink to="/">
            <NuxtImg
              class="md-mx absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 object-cover dark:brightness-[190%] dark:grayscale extra-max:pb-7 md-max:w-48 md-max:pb-0 extra-min:pb-0"
              to="/"
              src="/images/logo.png"
              width="240"
            />
