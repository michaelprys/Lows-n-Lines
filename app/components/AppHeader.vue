    ...
    <div class="sticky top-0 z-[10] w-full">
        <ItemObserver v-slot="{ isVisible }">
            <header
                ...
                :class="[{ active: isHidden }, isVisible ? 'fade-in' : 'invisible']"
                ref="el">
                <nav
                    ...
                    <div class="row-start-3 extra-max:justify-self-center md-max:hidden">
                        <ul class="text-md flex flex-1 items-center gap-10 dark:text-dark-el">
                    ...
                    <div class="row-start-2 flex flex-1 justify-end">
                        <button class="mr-10 block lg-max:mr-4" @click="setColorTheme()">
                            <IconDarkMode class="stroke-[#33363F] dark:stroke-dark-el" aria-label="dark mode icon" />
                        </button>
                        <div v-if="!loggedIn">
                        ...
                        <div class="flex items-center gap-10 lg-max:gap-4" v-else>
                            <NuxtLink class="flex items-center gap-2" to="/profile">
                                <span class="lg-max:hidden">Profile</span>
                                <IconProfile class="lg-min:hidden" aria-label="user profile icon" />
                            </NuxtLink>
                    ...
                    <NuxtLink to="/">
                        <NuxtImg
                            class="md-mx w-[15rem] absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 object-cover dark:brightness-[190%] dark:grayscale extra-max:pb-7 md-max:w-48 md-max:pb-0 sm-max:w-40 extra-min:pb-0"
                            to="/"
                            src="/images/logo.png"
                            width="292"
                            height="75"
...
.header {
    ...
    transition: transform 0.3s cubic-bezier(0.4, 0, 0.2, 1), background-color 150ms cubic-bezier(0.4, 0, 0.2, 1);
