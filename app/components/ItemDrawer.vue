      ...
      <ul class="space-y-2 font-medium">
        ...
        <li>
          ...
          >
            ...
            <span class="ms-3 flex-1 whitespace-nowrap">Service Center</span>
          </a>
        </li>
        <li>
          <a
          ...
          >
            ...
            <span class="ms-3 flex-1 whitespace-nowrap">Events</span>
          </a>
        </li>
        <li>
          <a
          ...
          >
            ...
            <span class="ms-3 flex-1 whitespace-nowrap">About Us</span>
          </a>
        </li>
        <li>
          <a
