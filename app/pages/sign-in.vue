...
<template>
    <div>
        <form
            ...
            <div class="mt-5 flex flex-col gap-5">
                ...
                <div class="flex items-center justify-between">
                    <NuxtLink class="underline transition-colors hover:text-gray-500" to="/reset-password"
        ...
        <span class="mb-10 mt-5 block text-center text-white"
            >Don't have an account?<NuxtLink class="ml-1.5 text-[#ff0000]" to="/sign-up">Create one</NuxtLink></span
        >
    </div>
</template>
