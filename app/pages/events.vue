    ...
    <section class="container mt-16 w-full max-w-[1240px]">
      <ItemObserver v-slot="{ isVisible }">
        <div :class="{ 'fade-in': isVisible }">
          ...
          <p class="mt-3">
            ...
            heritage of lowriders, showcasing the culture as a unique form of
            American folk and contemporary art. Join us for a curated community
            and cultural exhibition that explores and presents the vibrant world
            of lowriders.
          </p>
        </div>
      </ItemObserver>
      ...
      <ItemObserver v-slot="{ isVisible }">
        <p class="mt-14" :class="{ 'fade-in': isVisible }">
          ...
          grant management worldwide reproduction rights to use your name and
          likeness in all media, including the internet, for purposes without
          further compensation to you. You agree to hold management harmless for
          any claims relating to personal injury, damage to property, or use of
